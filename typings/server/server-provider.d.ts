 ...
 */
export declare function FLEX_SSR_SERIALIZER_FACTORY(serverSheet: StylesheetMap, mediaController: MatchMedia, _document: Document, breakpoints: BreakPoint[]): () => void;
/**
